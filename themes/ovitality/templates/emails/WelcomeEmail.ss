<div style="font-family:Arial; font-size:10pt;">
	...
	<p style="margin:0; padding:0; margin:0; margin-bottom:15px;">You can now log into your <a href="{$DashboardPage.Link}">Members Area</a> section of our website. You can also update your contact details using this service.</p>
